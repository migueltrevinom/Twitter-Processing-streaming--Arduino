...
StatusListener listener = new StatusListener() {
  ...
  public void onStatus(Status status) {
    ...
    //delay(5000);
    if (status.getText().indexOf("FWD") > 0)  { myPort.write('1'); }
    //delay(3000);
    else if (status.getText().indexOf("BKW") > 0)  { myPort.write('2'); }
    //delay(3000);
    else if (status.getText().indexOf("RHT") > 0)  { myPort.write('3'); }
    //delay(3000);
    else if (status.getText().indexOf("LFT") > 0)  { myPort.write('4'); }
    else { myPort.write('1'); }
    //delay(5000);
